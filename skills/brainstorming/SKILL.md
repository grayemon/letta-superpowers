...
7. **Write design doc** — save to `letta-superpowers/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `letta-superpowers/specs/YYYY-MM-DD-<topic>-design.md`
